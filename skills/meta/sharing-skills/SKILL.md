...
- Working directory is `/Users/williamflemmer/Documents/claude-config/` (your local clone)
...
```bash
cd /Users/williamflemmer/Documents/claude-config/
git checkout master
...
# (Work on skills/category/async-patterns/SKILL.md)
...
# 6. Create PR (if sharing to upstream repository)
gh pr create \
...
**PR merge conflicts**
- Rebase on latest master: `git fetch origin && git rebase origin/master`
- Resolve conflicts
